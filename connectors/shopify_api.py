...
class ShopifyAPI:
    ...
    def get_variant_ids_by_skus(self, skus: list, search_by_product_sku=False) -> dict:
        ...
        # ⚡ Bolt Optimization: Batch size increased from 2 to 20
        # Reduced manual sleep as we now rely on execute_graphql's adaptive rate limiter
        batch_size = 20
        ...
        for i in range(0, len(sanitized_skus), batch_size):
            ...
            # Increased products limit to 25 to handle larger batch
            query = """
            ...
            try:
                ...
                # ⚡ Bolt: Removed 3s sleep.
                # If needed, execute_graphql handles rate limiting.
                # A tiny breath just to be safe if rapid fire.
