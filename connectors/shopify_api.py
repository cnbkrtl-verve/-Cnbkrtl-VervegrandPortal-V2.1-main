...
class ShopifyAPI:
    ...
    def __init__(self, store_url: str, access_token: str, api_version: str = '2024-10'): # api_version parametresi burada ekli olmalı
        ...
        self.store_url = store_url.replace('http://', 'https://') if store_url.startswith('http') else f"https://{store_url.strip()}"
    ...
    def get_variant_ids_by_skus(self, skus: list, search_by_product_sku=False) -> dict:
        ...
        # Performance optimization: Increased batch size to 10 and relying on execute_graphql rate limiter
        batch_size = 10
