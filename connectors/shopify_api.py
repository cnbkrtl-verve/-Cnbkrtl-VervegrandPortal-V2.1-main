...
class ShopifyAPI:
    ...
    def get_dashboard_stats(self):
        """Dashboard için detaylı istatistikleri getir - Optimize edilmiş tek sorgu ile"""
        stats = {
            'shop_info': {},
            'orders_today': 0,
            'orders_this_week': 0,
        ...
        try:
            ...
            # ⚡ Performans Optimizasyonu: 6 ayrı sorgu yerine tek bir "aliased" sorgu
            # Bu değişiklik 6 HTTP isteğini 1'e indirir ve dashboard açılışını hızlandırır.
            combined_query = """
            query getDashboardStats($todayQuery: String!, $weekQuery: String!, $monthQuery: String!) {
              shop {
                name
                email
                primaryDomain { host }
            ...
            # Müşteri sayısı (tahmini)
            # Not: Analytics API olmadan tam sayı alınamaz
